...
// MARK: - Usage Example
/*
 Usage in your AdvancedInputBar:
 
 1. The SpeechRecognizer is already initialized as:
    @StateObject private var speechRecognizer = SpeechRecognizer()
 
 2. Request authorization on appear:
    .onAppear {
        speechRecognizer.requestAuthorization()
    }
 
 3. Start transcribing when mic button is pressed:
