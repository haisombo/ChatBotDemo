...
struct ChatContentView: View {
    ...
    var body: some View {
        ...
        ScrollViewReader { proxy in
            ...
            .onReceive(viewModel.$messages.throttle(for: 0.1, scheduler: RunLoop.main, latest: true)) { messages in
...
// 5. SIMPLE File Attachment (No heavy views)
...
//        .overlay(
//            RoundedRectangle(cornerRadius: 12, style: .continuous)
//                .stroke(Color(red: 0.85, green: 0.82, blue: 0.95), lineWidth: 1)  // Purple border
//        )
    }
}
